...
if __name__ == "__main__":  
   ...
   for dataset in tqdm(datasets):
      ...
      for i,(batch_size,lr,epoch,add2input4hidden) in  enumerate(all_perm):    
         ...
         baseline = subprocess.check_output("python3.6 main_best_focal_l2_acc_val.py  --seed 1234  --dataset "+dataset+arg_str, shell=True)
         ...
         focal  = subprocess.check_output("python3.6 main_best_focal_l2_acc_val.py --seed 1234 --focal True --dataset "+ dataset + arg_str, shell=True)
         ...
         only_acc  = subprocess.check_output("python3.6 main_best_focal_l2_acc_val.py  --seed 1234  --accloss True --det True --onlyacc True --dataset "+ dataset + arg_str, shell=True)
         ...
         accloss_det  = subprocess.check_output("python3.6 main_best_0.5_0_val.py  --seed 1234  --accloss True --det True --dataset "+ dataset + arg_str, shell=True)
         ...
         F_str = str("0,0.5")
         hf = 1.9         
         accloss_det0_05  = subprocess.check_output("python3.6 main_best_0.5_0_val.py --seed 1234  --accloss True --det True --F "+ F_str +" --hf "+ str(hf) +" --dataset "+ dataset + arg_str, shell=True)
         ...
         hf = 1
         accloss_det0till05  = subprocess.check_output("python3.6 main_best_0.5_0_val.py --seed 1234  --accloss True --det True --F "+ F_str +" --hf "+ str(hf) +" --dataset "+ dataset + arg_str, shell=True)
   ...
   path = "50_8_0.01_0.005_0.001_2fc_seed1234_val"
